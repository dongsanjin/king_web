  ...
  <div class="page-hero" v-if="model">
    ...
    <div>
      <div class="bg-white px-3">
        <div class="nav d-flex jc-around pt-3 tb-2 border-bottom">
      ...
      <swiper>
        <swiper-slide>
          <div>
            ...
            <my-card plain icon="back" title="出装推荐" class="hero-items">
            ...
            <my-card plain icon="back" title="使用技巧">
              <p class="m-0">{{model.usageTips}}</p>
            </my-card>

            <my-card plain icon="back" title="对抗技巧">
              <p class="m-0">{{model.battleTips}}</p>
            </my-card>

            <my-card plain icon="back" title="团战思路">
              <p class="m-0">{{model.teamTips}}</p>
            </my-card>

            <my-card plain icon="back" title="英雄关系">
